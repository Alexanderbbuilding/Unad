...
require_once '../../conexion/DBclass.php';
 ...
 $result = mysqli_query( $db->con, "SELECT COUNT(*) AS count FROM  reporte_m   ");    
 ...
 $SQL = "SELECT Nombres,Nombre,Fecha_Registro,Peso_Actual,Talla_Actual,Observaciones,Numero_Toma,Estado  from reporte_m    LIMIT $start , $limit" ;
