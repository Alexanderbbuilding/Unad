...
require_once '../../conexion/DBclass.php';
 ...
 while($row = mysqli_fetch_array($result)) {
 	...
 	$responce->rows[$i]['cell']=array($row['idValoracion'],$row['Numero_Toma'], $row['nin'],$row['Fecha_Registro'],$row['Peso_Actual'],$row['Talla_Actual'],$row['Nombre'],$row['tipo_res'],$row['funcionario'],$row['nivel'],$link); $i++;  
 }
