...
<div class="container-fluid">
	...
	<div class="col-xs-9 col-sm-10 col-md-10 col-lg-10 col-xs-offset-3 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 main">
		...
		<h1 class="page-header">Institucion<a href="addinstitucion.php" class="btn btn-success pull-right"> <i class="fa fa-edit"> </i>Agregar Nueva Institucion</a></h1>
...
<script>
   jQuery("#list2").jqGrid({ 
   url:'ajax/ajaxinstitucion.php', 
   datatype: "json",
   colNames:['ID','Nombre','Direccion','Ciudad','Telefono', 'Nit','Opciones'], 
   colModel:[ 
