...
<div class="container-fluid">
	...
	<div class="col-xs-9 col-sm-10 col-md-10 col-lg-10 col-xs-offset-3 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 main">
		...
		<h1 class="page-header">Persona<a href="addp3.php" class="btn btn-success pull-right"> <i class="fa fa-edit"> </i>Agregar Nueva Persona</a></h1>
...
<script>
   ...
   datatype: "json",
   colNames:['ID','Nombres','Apellidos','fecha Nacimiento','Genero', 'Peso de Nacimiento','Talla','Tipo de Documento','Opciones'], 
   colModel:[ 
      	   {name:'idTipo_Documento',index:'idTipo_Documento', align:"center",key : true, sorttype:'integer', searchoptions:{sopt:['eq','ne','le','lt','gt','ge']}}, 
		   {name:'Nombres',index:'Nombres'}, 
		{name:'Apellidos',index:'Apellidos'}, 
    {name:'fecha_nacimiento',index:'fecha_nacimiento'}, 
    {name:'genero',index:'genero'}, 
    {name:'peso_nacimiento',index:'peso_nacimiento'}, 
{name:'talla',index:'talla'}, 

{name:'idTipo_Documento',index:'idTipo_Documento'}, 
