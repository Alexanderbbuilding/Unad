...
<div class="container-fluid">
	...
	<div class="col-xs-9 col-sm-10 col-md-10 col-lg-10 col-xs-offset-3 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 main">
		...
		<h1 class="page-header">Tipo de Resultado<a href="addresultado.php" class="btn btn-success pull-right"> <i class="fa fa-edit"> </i>Agregar Nuevo Resultado</a></h1>
...
<script>
   jQuery("#list2").jqGrid({ 
   url:'ajax/ajaxtresultado.php', 
   datatype: "json",
   colNames:['ID','Descripcion ', 'Opciones'], 
   colModel:[ 
      	   {name:'idTipo_Resultado',index:'idTipo_Resultado', align:"center",key : true, sorttype:'integer', searchoptions:{sopt:['eq','ne','le','lt','gt','ge']}}, 
